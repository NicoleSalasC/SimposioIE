...
<html lang="en">
    <head>
        ...
        <title>Simposio Informática Empresarial</title>
    ...
    <body>
        <header>
            <div class="logos">
                <img src="img/logoUCR.png" alt="logo ucr" class="ucrlogo"/>
                <img src="img/logoCarrera.png" alt="Logo CIE regional" class="cielogo"/>
            </div>
            <nav>
                <a href="#">Accesibilidad</a>
                <a href="index.jsp">Inicio</a>
                <a href="registerPage.jsp">Participar</a>
                <a href="#contact-sesion">Contactanos</a>
                <a href="#">Cronograma</a>
        ...
        <main>
            ...
            <section class=" container-info">
                ...
                <div class="img-container">
                    <img class="img-container" src="img/fotoSede.jpeg" alt="Imagen Sede Sur width="600 height="405" alt="Imagen Sede Sur" style="border-radius: 30px;">
                </div>
            </section> 
        ...
        <footer class="footer">
            <div>&copy; Nicol LA PUBIC. All rights reserved.</div>
            <nav>
                <a href="#">ASDFGHJKL</a>
                <a href="#">AZSD</a>
            </nav>
